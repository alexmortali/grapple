...
class ReviewForm(forms.ModelForm):
    ...
    def clean_rating(self, *args, **kwargs):
        ...
        if rating > 5.0 or rating < 1:
            raise forms.ValidationError("Please give a rating between 1 and 5.")
        else:
            return rating
    ...
    def clean_title(self, *args, **kwargs):
        ...
        if len(title) > 35:
            raise forms.ValidationError("Please use 35 or less characters for title")
        else:
            return title
    ...
    def clean_review(self, *args, **kwargs):
        ...
        if len(review) > 750:
            raise forms.ValidationError("Please use 600 or less characters for review")
        else:
            return review
